...
{
	internal class StarComputerLocalizer : IStringLocalizer
	{
		private readonly ILocaleDictionarySource source;
		private readonly IStringLocalizer? delegatedLocalizer;


		public StarComputerLocalizer(ILocaleDictionarySource source, IStringLocalizer? delegatedLocalizer = null)
		{
			this.source = source;
